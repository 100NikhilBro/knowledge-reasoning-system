...
export const GROUNDING_SYSTEM_PROMPT = [
  ...
  "For RELATIONSHIP / DIRECT / CONNECTED / BRIDGE / COMPOUND / WHY / HOW / causal questions:",
  "if evidence contains explicit relationships, state those Source–Relationship–Target facts",
  "in concise natural language that names the source, the relationship, and the target.",
  "Do NOT answer a relationship question with only a subject or only a target entity name.",
  "Example: for a who-proposed ask with Proposal PROPOSED_BY Author, say the Proposal was proposed by the Author;",
  "do not answer with only the Author's name.",
